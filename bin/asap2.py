...
classification(args.outdir+'/featureMerged/merged-rep-seqs.qza',args.outdir+'/diversity/rarefied_table.qza',home+'/../lib/classifier/'+args.clas,args.outdir+'/featureMerged/merged-metadata.tsv',args.outdir+'/taxonomy',args.conf,args.proc)
